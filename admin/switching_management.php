...
<div class="con_box r_ship_w">
    ...
    <h1 class="con_tit_name"><i class="fas fa-grip-vertical"></i>  교환 관리</h1>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" id="swi1-1" value="" name="swi_m1" class="radio_style"><label for="swi1-1"><span></span> 전체</label>
                                <input type="radio" id="swi1-2" value="" name="swi_m1" class="radio_style"><label for="swi1-2"><span></span> 회원</label>
                                <input type="radio" id="swi1-3" value="" name="swi_m1" class="radio_style"><label for="swi1-3"><span></span> 비회원</label>
                            </td>
                        </tr>
                        <tr>
                            <td class="fa_tit">교환 처리 유형</td>
                            <td>
                                <input type="radio" id="swi_m2-1" value="" name="swi_m2" class="radio_style"><label for="swi_m2-1"><span></span> 전체</label>
                                <input type="radio" id="swi_m2-2" value="" name="swi_m2" class="radio_style"><label for="swi_m2-2"><span></span> 교환 접수</label>
                                <input type="radio" id="swi_m2-3" value="" name="swi_m2" class="radio_style"><label for="swi_m2-3"><span></span> 교환 완료</label>
                                <input type="radio" id="swi_m2-4" value="" name="swi_m2" class="radio_style"><label for="swi_m2-4"><span></span> 교환 거부, 불가, 보류</label>
                                <input type="radio" id="swi_m2-5" value="" name="swi_m2" class="radio_style"><label for="swi_m2-5"><span></span> 교환 준비</label>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="tab_style_3">
                <div class="tab-content j_btn_box">
                    <ul class="nav j_nav-pills3">
                        ...
                        <li class=""><a data-toggle="pill" href="#tabcb">교환 신청</a></li>
                        <li class=""><a data-toggle="pill" href="#tabcc">교환 접수</a></li>
                        <li class=""><a data-toggle="pill" href="#tabcd">교환 완료</a></li>
                        <li class=""><a data-toggle="pill" href="#tabce">교환 거부/불가/보류</a></li>
                        <li class=""><a data-toggle="pill" href="#tabcf">교환 준비</a></li>
                    </ul>
                    <div id="tabca" class="tab-pane fade active in">
                        ...
                        <div class="r_btn_box j_btn_box">
                            <div class="r_btn_box">
                                <button class="p_btn btn_default_two r_btn_two r_btn2">교환 완료 처리</button>
