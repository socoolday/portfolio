...
<div class="con_box">
    ...
    <h1 class="con_tit_name"><i class="fas fa-grip-vertical"></i> 기획전 관리하기</h1>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="radio" id="sel_2" value="" name="sel_1" class="radio_style"><label for="sel_2"><span></span> 진행함</label>
                                <input type="radio" id="sel_3" value="" name="sel_1" class="radio_style"><label for="sel_3"><span></span> 진행안함</label>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="tab_style_3">
                <div class="tab-content">
                    ...
                    <ul class="nav j_nav-pills">
                        <li class="active"><a data-toggle="pill" href="#tabca">진행 중 기획전</a></li>
                        <li class=""><a data-toggle="pill" href="#tabcb">종료된 기획전</a></li>
                    </ul>
                    ...
                    <div id="tabca" class="tab-pane fade active in">
                        <div class="table-responsive form_info_b">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>10</td>
                                    <td class="jtp_q"><a href=""><img src="../../images/prd_img.png" alt=""></a></td>
                                    <td>티플레이트</td>
                        ...
                        <div class="r_btn_box">
                            <div class="r_btn_left">
                                <button class="p_btn r_btn_two j_btn btn_default_two">기획전 보러가기</button>
                            </div>
                            <div class="r_btn_right2">
                                <button class="p_btn r_btn_two j_btn btn_default_two" onclick="location.href='registered_exhibition.php' ">등록하기</button>
