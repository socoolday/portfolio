...
<div class="con_box r_ship_w">
    ...
    <h1 class="con_tit_name"><i class="fas fa-grip-vertical"></i>  취소 관리</h1>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" id="can_m1-1" value="" name="can_m1" class="radio_style"><label for="can_m1-1"><span></span> 전체</label>
                                <input type="radio" id="can_m1-2" value="" name="can_m1" class="radio_style"><label for="can_m1-2"><span></span> 회원</label>
                                <input type="radio" id="can_m1-3" value="" name="can_m1" class="radio_style"><label for="can_m1-3"><span></span> 비회원</label>
                            </td>
                        </tr>
                        <tr>
                            <td class="fa_tit">취소 유형</td>
                            <td>
                                <input type="radio" id="can_m2-1" value="" name="can_m2" class="radio_style"><label for="can_m2-1"><span></span> 전체</label>
                                <input type="radio" id="can_m2-2" value="" name="can_m2" class="radio_style"><label for="can_m2-2"><span></span> 고객취소</label>
                                <input type="radio" id="can_m2-3" value="" name="can_m2" class="radio_style"><label for="can_m2-3"><span></span> 관리자 취소</label>
                                <input type="radio" id="can_m2-4" value="" name="can_m2" class="radio_style"><label for="can_m2-4"><span></span> 자동취소</label>
                            </td>
                        </tr>
                        <tr>
                            <td class="fa_tit">취소 처리</td>
                            <td>
                                <input type="radio" id="can_m3-1" value="" name="can_m3" class="radio_style"><label for="can_m3-1"><span></span> 전체</label>
                                <input type="radio" id="can_m3-2" value="" name="can_m3" class="radio_style"><label for="can_m3-2"><span></span> 처리완료</label>
                                <input type="radio" id="can_m3-3" value="" name="can_m3" class="radio_style"><label for="can_m3-3"><span></span> 처리 중</label>
                                <input type="radio" id="can_m3-4" value="" name="can_m3" class="radio_style"><label for="can_m3-4"><span></span> 보류</label>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="tab_style_3">
                <div class="tab-content j_btn_box">
                    <ul class="nav j_nav-pills2">
                        ...
                        <li class=""><a data-toggle="pill" href="#tabcb">고객 취소</a></li>
                        <li class=""><a data-toggle="pill" href="#tabcc">관리자 취소</a></li>
                        <li class=""><a data-toggle="pill" href="#tabcd">자동 취소</a></li>
                    </ul>
                    <div id="tabca" class="tab-pane fade active in">
                        <div class="r_list_box">
                            <p>검색 결과 취소 금액 : <span>456,654,000</span> 원</p>
                        </div>
                        <div class="table-responsive form_info_b">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="5">카드결제</td>
                                    <td rowspan="5">관리자 취소</td>
                                    <td rowspan="5">처리완료</td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2">카드결제</td>
                                    <td rowspan="2">자동취소</td>
                                    <td rowspan="2">처리완료</td>
                                </tr>
                                <tr>
                                    <td>
                                        [티플레이트] 티플레이트 미로틱 티컵 세트<br>
                        ...
                        <div class="r_btn_box j_btn_box">
                            <div class="r_btn_box">
                                <button class="p_btn btn_default_two r_btn_two r_btn2">처리완료</button>
