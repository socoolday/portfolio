...
<div class="con_box">
    ...
    <h1 class="con_tit_name"><i class="fas fa-grip-vertical"></i> 메시지 발송 내역</h1>
        ...
        <div class="form_ad">
            <div class="table-responsive">          
                <table class="table">
                    <tbody>
                        <tr>
                            <td class="fa_tit">수신 유형</td>
                            <td>
                                <input type="radio" id="mes_s1-1" value="" name="mes_s1" class="radio_style"><label for="mes_s1-1"><span></span> 전체</label>
                                <input type="radio" id="mes_s1-2" value="" name="mes_s1" class="radio_style"><label for="mes_s1-2"><span></span> 예약발송</label>
                                <input type="radio" id="mes_s1-3" value="" name="mes_s1" class="radio_style"><label for="mes_s1-3"><span></span> 즉시발송</label>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="form_ad">
            ...
            <div class="r_btn_box j_btn_box">
                <div class="r_btn_left">
                    <button class="p_btn r_btn_two j_btn btn_default_two">SMS 발송하기</button>
                </div>
