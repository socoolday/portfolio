...
<div class="con_box">
    ...
    <h1 class="con_tit_name"><i class="fas fa-grip-vertical"></i>  주간 매출</h1>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="p_btn btn_default_third active">이번주</button>
                                <button type="button" class="p_btn btn_default_third">1주 전</button>
                                <button type="button" class="p_btn btn_default_third">2주 전</button>
                                <button type="button" class="p_btn btn_default_third">4주 전</button>
