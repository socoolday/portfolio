...
<div class="con_box r_ship_w">
    ...
    <h1 class="con_tit_name"><i class="fas fa-grip-vertical"></i>  입금 대기 취소 관리</h1>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" id="can_d1-1" value="" name="can_d1" class="radio_style"><label for="can_d1-1"><span></span> 전체</label>
                                <input type="radio" id="can_d1-2" value="" name="can_d1" class="radio_style"><label for="can_d1-2"><span></span> 회원</label>
                                <input type="radio" id="can_d1-3" value="" name="can_d1" class="radio_style"><label for="can_d1-3"><span></span> 비회원</label>
                            </td>
                        </tr>
                        <tr>
                            <td class="fa_tit">취소 유형</td>
                            <td>
                                <input type="radio" id="can_d2-1" value="" name="can_d2" class="radio_style"><label for="can_d2-1"><span></span> 전체</label>
                                <input type="radio" id="can_d2-2" value="" name="can_d2" class="radio_style"><label for="can_d2-2"><span></span> 고객취소</label>
                                <input type="radio" id="can_d2-3" value="" name="can_d2" class="radio_style"><label for="scan_d2-3"><span></span> 관리자 취소</label>
                                <input type="radio" id="can_d2-4" value="" name="can_d2" class="radio_style"><label for="can_d2-4"><span></span> 자동 취소</label>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="tab_style_3">
                <div class="tab-content j_btn_box">
                    <ul class="nav j_nav-pills">
                        <li class="active"><a data-toggle="pill" href="#tabca">전체 취소</a></li>
                        <li class=""><a data-toggle="pill" href="#tabcb">부분 취소</a></li>
                    </ul>
                    ...
                    <div id="tabca" class="tab-pane fade active in">
                        ...
                        <div class="r_btn_box j_btn_box">
                            <div class="r_btn_left">
                                <button class="p_btn r_btn_two j_btn btn_default_two">입금 완료 처리</button>
                            </div>
