...
<div class="con_box r_class r_inv">
    ...
    <h1 class="con_tit_name"><i class="fas fa-grip-vertical"></i>  품절 상품 관리</h1>
                ...
                <ul class="class_list1">
                    <li>
                        ...
                        <ul class="class_list2">
                            ...
                            <li><a href=""><i class="fas fa-ellipsis-h"></i> 카테고리1-9</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <table class="table">
                        <tbody>
                           <tr>
                            ...
                            <tr>
                                <td class="fa_tit">상태</td>
                                <td>
                                    <input type="radio" id="man_o1-1" value="" name="man_o1" class="radio_style"><label for="man_o1-1"><span></span> 전체</label>
                                    <input type="radio" id="man_o1-2" value="" name="man_o1" class="radio_style"><label for="man_o1-2"><span></span> 진열 안함</label>
                                    <input type="radio" id="man_o1-3" value="" name="man_o1" class="radio_style"><label for="man_o1-3"><span></span> 진열 상품</label>
                                </td>
                            </tr>
                            <tr>
...
<div class="modal fade r_tax" id="myModal" role="dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">품절 상품 리스트 수정하기</h4>
        </div>
