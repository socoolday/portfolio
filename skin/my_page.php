...
<?php include "./lib/page_category.php"; ?>
				...
				<div class="myshop">
					<div class="ms_art">
				        <div class="msa_b">
                            <h3>즐겨찾기</h3>
                            <ul>
                                <li><a href=""><p>관심 상품</p> <span>0</span></a></li>
                                <li><a href=""><p>관심 브랜드</p> <span>15</span></a></li>
                                <li><a href=""><p>장바구니</p> <span>5</span></a></li>
                            </ul>
						</div>
					</div>
					<div class="ms_art">
					    <div class="msa_b">
                            <h3>이용정보</h3>
                            <ul>
                                <li><a href=""><p>상품Q&amp;A</p> <span>0</span></a></li>
                                <li><a href=""><p>내 상품평</p> <span>24</span></a></li>
                                <li><a href=""><p>1:1 문의</p> <span>0</span></a></li>
                            </ul>
                        </div>
					</div>
					<div class="ms_art">
					    <div class="msa_b">
                            <h3>이벤트</h3>
                            <ul>
                                <li><a href=""><p>응모한 이벤트</p> <span>0</span></a></li>
                                <li><a href=""><p>관심 이벤트/기획전</p> <span>24</span></a></li>
                                <li><a href=""><p>당첨자 발표</p> <i class="xi-external-link"></i></a></li>
                            </ul>
                        </div>
					</div>
					<div class="ms_art">
					    <div class="msa_b ">
                            <h3>배송지</h3>
                            <button type="button" class="btn navy" data-bs-toggle="modal" data-bs-target=".change_address">배송지 추가</button>
                            <div class="msab_und">
                                <ul>
                                    <li class="active">
                                        <h4>집</h4>
                                        <p>서울특별시 서울구 서울동 서울아파트 000번지 000-000</p>
                                        <span>최종 수정일 : 2019-03-01</span>
                                        <div class="msab_btn_group">
                                            <button type="button"> 기본 배송지</button>
                                            <button type="button" class="msab_add_del"><i class="xi-minus-circle"></i>삭제</button>
                                            <button type="button" class="msab_add_del" data-bs-toggle="modal" data-bs-target=".modify_address"><i class="xi-pen-o"></i>수정</button>
                                        </div>
                                    </li>
                                    <li>
                                        <h4>회사</h4>
                                        ...
                                        <div class="msab_btn_group">
                                            <button type="button" class="msab_add_del"><i class="xi-minus-circle"></i>삭제</button>
                                            <button type="button" class="msab_add_del"><i class="xi-pen-o"></i>수정</button>
                                        </div>
                                    </li>
                                    <li>
                                        <h4>본가</h4>
					...
					<div class="ms_art">
					    <div class="msa_b">
                            <h3>이메일</h3>
                            <button type="button" class="btn navy" data-bs-toggle="modal" data-bs-target=".change_email">변경하기</button>
                            <div class="msab_und">
                                <p>tmall@tmallemail.com (수신동의 여부 : <strong>수신</strong>)</p>
                                <span>최종 수정일 : 2019-03-01</span>
                            </div>
                        </div>
					</div>
					<div class="ms_art">
					    <div class="msa_b">
                            ...
                            <h3>연락처</h3>
                            <button type="button" class="btn navy" data-bs-toggle="modal" data-bs-target=".change_contact">변경하기</button>
                            <div class="msab_und">
                                <p>000-0000-0000 (수신동의 여부 : <strong>비수신</strong>)</p>
                                <span>최종 수정일 : 2019-03-01</span>
                            </div>
                        </div>
					</div>
                        ...
                        <div class="modal_comenP_table">
                            ...
                            <div class="modal_comenP_it">
                                <div class="modal_comenp_itL">
                                    <div class="modal_comenp_itL_b">
                                        <div class="modal_file"><button type="button"><img src="./images/prd_5.png" alt=""></button></div>
                                        <div class="modal_file"><button type="button"><img src="./images/prd_5.png" alt=""></button></div>
                                        <div class="modal_file"><button type="button"><img src="./images/prd_5.png" alt=""></button></div>
                                        <div class="modal_file"><button type="button"><img src="./images/prd_5.png" alt=""></button></div>
                                    </div>
    ...
    <!-- 배송지 수정 팝업 -->
    <div class="modal fade modify_address my_modal" role="dialog">
        <div class="modal-dialog">
    ...
    <!-- 연락처 변경 팝업 -->
    <div class="modal fade change_contact my_modal" role="dialog">
        <div class="modal-dialog">
